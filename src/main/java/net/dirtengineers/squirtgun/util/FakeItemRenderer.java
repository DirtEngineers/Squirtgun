...
public class FakeItemRenderer {
    ...
    private static BakedModel getBakedModel(ItemStack pItemStack) {
        ModelResourceLocation itemModel = getItemModel(pItemStack);
        return itemModel != null ? ITEM_RENDERER.getItemModelShaper().getModelManager().getModel(itemModel) : ITEM_RENDERER.getModel(pItemStack, null, MINECRAFT.player, 0);
    }
     ...
     */
    @Nullable
    private static ModelResourceLocation getItemModel(ItemStack pItemStack) {
