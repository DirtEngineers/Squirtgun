...
class WrappedVertexConsumer_OLD implements VertexConsumer {
    ...
    public WrappedVertexConsumer_OLD(VertexConsumer pConsumer, float pRed, float pGreen, float pBlue, float pAlpha) {
