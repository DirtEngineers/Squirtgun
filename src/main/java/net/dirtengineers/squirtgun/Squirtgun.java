...
public class Squirtgun {
    ...
    public Squirtgun() {
        ...
        modEventBus.addListener(ItemRegistration::registerMags);
    }

    private void commonSetupEvent(final FMLCommonSetupEvent event) {
//        for (Chemical chemical : ItemRegistration.ammunitionLiquids)
...
//                ItemRegistration.ammunition.put(ForgeRegistries.FLUIDS.getValue(new ResourceLocation(location)), chemical);
//            }
    }
}