...
public class PhialRecipeSerializer<T extends PhialRecipe> implements RecipeSerializer<T> {
    private final IFactory<T> factory;

    public PhialRecipeSerializer(IFactory<T> pFactory) { this.factory = pFactory; }
