...
public class PhialTypeCreationRecipe extends AbstractProcessingRecipe {
    private final ItemStack phial;
    private final FluidStack fluid;
    private final ItemStack output;

    public PhialTypeCreationRecipe(ResourceLocation pId, String pGroup, ItemStack pPhial, FluidStack pFluidStack, ItemStack pOutput) {
        super(pId, pGroup);
        this.phial = pPhial;
