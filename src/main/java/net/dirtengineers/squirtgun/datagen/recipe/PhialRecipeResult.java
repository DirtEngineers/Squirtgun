...
public class PhialRecipeResult implements FinishedRecipe {
    ...
    public PhialRecipeResult(String pGroup, Advancement.Builder pBuilder, ResourceLocation pId, ResourceLocation pAdvancementId, ItemStack pPhial, FluidStack pFluid, ItemStack pResult) {
        this.group = pGroup;
