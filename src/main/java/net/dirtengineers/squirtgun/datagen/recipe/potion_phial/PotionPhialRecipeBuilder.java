...
public class PotionPhialRecipeBuilder implements RecipeBuilder {
    ...
    private final ItemStack bottleOutput;
    private final Advancement.Builder advancementBuilder = Advancement.Builder.advancement();

    public PotionPhialRecipeBuilder(ItemStack pPhial, Potion pPotion, ItemStack pPhialOutput, ItemStack pBottleOutput, ResourceLocation pRecipeId) {
        phial = pPhial;
        potion = pPotion;
        phialOutput = pPhialOutput;
        bottleOutput = pBottleOutput;
        recipeId = pRecipeId;
    }

    public static PotionPhialRecipeBuilder createRecipe(ItemStack pInput1, Potion pInput2, ItemStack pPhialOutput, ItemStack pBottleOutput, ResourceLocation pRecipeId) {
        return new PotionPhialRecipeBuilder(pInput1, pInput2, pPhialOutput, pBottleOutput, pRecipeId);
    }
