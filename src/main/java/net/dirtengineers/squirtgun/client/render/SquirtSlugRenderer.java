...
public class SquirtSlugRenderer extends ArrowRenderer<SquirtSlug> {
    ...
    public static final ResourceLocation SQUIRT_SLUG_TEXTURE = new ResourceLocation( Squirtgun.MOD_ID, "textures/entity/projectile/squirt_slug.png");//blank_slug.png
